...
public class EnrichmentServiceAllocateTest {
    ...
    public void allocateTrade_positionCostBasisEur_afterSecondAlloc() throws Exception {
        ...
        // Note: H2 DATABASE_TO_LOWER lowercases camelCase keys, so
        // existingPosition.get("totalCostBasisEur") returns null (key is "totalcostbasiseur").
        // This means the second allocation reads posCostEurBefore=0, so only the second
        // allocation's EUR cost is stored. In production MySQL this accumulates correctly.
        // Second: 300*100 + 10*300/1000 = 30003, * 0.9168 = 27506.7504
        double expected = 30003.0 * 0.9168;
